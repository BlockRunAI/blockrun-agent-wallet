...
print('Your AI agent can now pay for premium APIs')
print('=' * 50)
print('DALL-E: "blockrun generate a sunset"')
print('Twitter: "blockrun check @elonmusk"')
print('GPT-5: "blockrun GPT review this code"')
print('-' * 50)
print(f'Wallet: {addr}')
print(f'Balance: ${bal:.2f} USDC')
if bal == 0:
    print('Fund: Send USDC (Base) to wallet to start')
print('=' * 50)
import sys
sys.stdout.flush()
PYEOF
